...
function Logo({ src, left, top, hover }) {
  return (
    <motion.img
      ...
      src={src}
      style={{ left, top }}
      className="absolute size-12 rounded-full bg-white shadow-sm ring-1 ring-black/5" // changed from size-16
    />
  )
}
  ...
  return (
    <div aria-hidden="true" className="relative h-full overflow-hidden">
      ...
      <div className="absolute left-1/2 h-full w-104 -translate-x-1/2">
        <MainLogo />
        <Logo
          src="/team/leonard-krasner.jpg"
          left={360}
          top={144}
          hover={{ x: 6, y: 1, rotate: 5, delay: 0.38 }}
        />
        <Logo
          src="/team/celeste-vandermark.jpg"
          left={285}
          top={20}
          hover={{ x: 4, y: -5, rotate: 6, delay: 0.3 }}
        />
        <Logo
          src="/team/nolan-sheffield.jpg"
          left={255}
          top={210}
          hover={{ x: 3, y: 5, rotate: 7, delay: 0.2 }}
        />
        <Logo
          src="/individual-investors/jenny-wilson.jpg"
          left={144}
          top={40}
          hover={{ x: -2, y: -5, rotate: -6, delay: 0.15 }}
        />
        <Logo
          src="/team/marcus-eldridge.jpg"
          left={36}
          top={56}
          hover={{ x: -4, y: -5, rotate: -6, delay: 0.35 }}
        />
        <Logo
          src="/individual-investors/benjamin-russel.jpg"
          left={96}
          top={176}
